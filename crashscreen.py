...
def crash(puntaje):
    ...
    while True:
        ...
        dManager.boton("Te chocaste!", params1, None)
        dManager.boton(sesion.nombreUsuario, params6, None)
        dManager.boton("Tu puntaje: " + str(puntaje), params2, None)
        dManager.boton("Nueva Partida", params3, gamescreen.game_bucle)
        dManager.boton("Regresar al menu", params5, oriongame.game_intro)
